...
def config():
    ...
    parser.add_argument("--version", type=str, default="A2C_phase2_v1.2_dist_returns_V(s)")
    parser.add_argument("--s_episode", type=int, default=2000) # episode_A 
    parser.add_argument("--agent_model", type=str, default="A2C")    

    parser.add_argument("--phase1_version", type=str, default='A2C_phase1_v2.2_dist_returns_V(s)')
